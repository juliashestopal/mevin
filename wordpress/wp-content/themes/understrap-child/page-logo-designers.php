<?php /* Template Name: Logo Designer form */ ?>
<?php
/**
...
$questions = (object)json_decode(file_get_contents(get_stylesheet_directory_uri() . "/includes/fiverr_logo.json"), false);
    ...
    <div class="top-container_fluid questionnaire <?php echo esc_attr($container); ?>" id="content" tabindex="-1">
        ...
        <div class="row">
            <div id="top-container" class="top-container col-md col-xl">
                ...
                <span> Get Detailed Research On The Best Logo Designers That Meet Your Needs Based On Hundreds Of Reviews. </span>
<!--                <div class="tags">-->
            ...
            <main class="site-main" id="main">
                ...
                <section class="questionnaire">
                    <form method="get" id="advanced-searchform" role="search" action="results/">
                        <input type="hidden" name="product_cat" value="fiverr_logo">
