			...
			<div class="col-md-8 col-xs-12">
				<div class="requirement">
					...
					<ul>
						...
						<li><?php echo $requirements->battery_life; ?>h battery life</li>
						<li>Sweat resistant</li>
						<li><?php echo $requirements->price; ?>$ budget</li>
					</ul>
            ...
            <div class="row">
                ...
                <div class="col-md-9">
                    <div class="card-body">
                        ...
                        <p><i class="fa rating rating-<?php echo number_format(round(get_post_meta($post->ID,'rating', true) / 5, 1) * 5, 1, '-', ',');?>"></i>
