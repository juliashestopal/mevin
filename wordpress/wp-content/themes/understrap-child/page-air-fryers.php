<?php /* Template Name: Air Fryer form */ ?>
<?php
/**
...
$questions = (object)json_decode(file_get_contents(get_stylesheet_directory_uri() . "/includes/air-fryers.json"), false);
            ...
            <main class="site-main" id="main">
                ...
                <section class="questionnaire">
                    <form method="get" id="advanced-searchform" role="search" action="results/">
                        <input type="hidden" name="product_cat" value="air-fryers">
